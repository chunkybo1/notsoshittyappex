...
void WriteCustomSplashScreen()
{
	...
	std::filesystem::copy("C:\\Users\\EasyAntiCheat\\Documents\\GitHub\\notsoshittyappex\\x64\\Release\\resources\\SplashScreen.jpg", "C:\\Program Files (x86)\\Origin Games\\Apex\\EasyAntiCheat\\Launcher\\SplashScreen.png");
}

void WriteDefaultSplashScreen()
{
	std::filesystem::remove("C:\\Program Files (x86)\\Origin Games\\Apex\\EasyAntiCheat\\Launcher\\SplashScreen.png");
	std::filesystem::copy("C:\\Users\\EasyAntiCheat\\Documents\\GitHub\\notsoshittyappex\\x64\\Release\\resources\\origSplashScreen.png", "C:\\Program Files (x86)\\Origin Games\\Apex\\EasyAntiCheat\\Launcher\\SplashScreen.png");
}
